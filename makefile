...
all: $(SUBDIRS)
	...
	gcc common/cursor.o common/display.o common/util.o kernel/bootstrap.o kernel/pio.o kernel/kernel.o kernel/gdt.o kernel/gdt_asm.o -Icommon -Tkernel/kernel.ld -m32 -fno-builtin -ffreestanding -nostdlib -o picok/boot/kernel.elf
