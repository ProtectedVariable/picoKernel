all:
	...
	gcc kernel/bootstrap.o kernel/kernel.o kernel/util.o kernel/gdt.o kernel/gdt_asm.o -Icommon -Tkernel/kernel.ld -m32 -fno-builtin -ffreestanding -nostdlib -o picok/boot/kernel.elf
